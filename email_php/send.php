...
$email_pengirim = 'audit.portal.capital@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Admin Audit'; // Isikan dengan nama pengirim
...
$mail->Password = 'giuzqltqdpqoanjk'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
if(empty($attachment)){ // Jika tanpa attachment
    ...
    if($send){ // Jika Email berhasil dikirim == nilai true
