...
class Otorisasi_model extends CI_Model
{
 ...
 //        $this->datatables->add_column('action', anchor(site_url('otorisasi_read_bisnis/tambah_data/$1'),'<i class="fa fa-plus" aria-hidden="true"></i> Tambah', array('class' => 'btn btn-primary btn-xs btn-flat')), 'id_cabang');
 //        return $this->datatables->generate();
 //    }
