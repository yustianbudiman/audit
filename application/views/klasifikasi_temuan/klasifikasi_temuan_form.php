    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA KLASIFIKASI_TEMUAN</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Klasifikasi Temuan <?php echo form_error('nama_klasifikasi_temuan') ?></td><td><input type="text" class="form-control" name="nama_klasifikasi_temuan" id="nama_klasifikasi_temuan" placeholder="Nama Klasifikasi Temuan" value="<?php echo $nama_klasifikasi_temuan; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_klasifikasi_temuan" value="<?php echo $id_klasifikasi_temuan; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('klasifikasi_temuan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>