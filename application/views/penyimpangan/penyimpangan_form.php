    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA PENYIMPANGAN</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Penyimpangan <?php echo form_error('nama_penyimpangan') ?></td><td><input type="text" class="form-control" name="nama_penyimpangan" id="nama_penyimpangan" placeholder="Nama Penyimpangan" value="<?php echo $nama_penyimpangan; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_penyimpangan" value="<?php echo $id_penyimpangan; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('penyimpangan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>