        ...
        <div class="box box-info">
          ...
          <div class="box-body pad" style="overflow: auto;">
            <table class="table table-bordered table-hover">
        	    <tr><td>Nama Penyimpangan</td><td><?php echo $nama_penyimpangan; ?></td></tr>
        	    ...
        	    <tr><td></td><td><a href="<?php echo site_url('penyimpangan') ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Kembali</a>
            </table>
          </div>       
        </div>
      </div>
