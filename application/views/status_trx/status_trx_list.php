            ...
            <div class="col-lg-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body pad" style="overflow: auto;">
                        ...
                        <?php echo anchor(site_url('status_trx/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                        <?php echo anchor(site_url('status_trx/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "status_trx/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_status",
                            "orderable": false
                        },{"data": "status_trx"},{"data": "aktif"},
                        {
                            "data" : "action",
                            "orderable": false,
