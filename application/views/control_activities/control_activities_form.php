    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA CONTOL_ACTIVITIES</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Contol Activities <?php echo form_error('nama_contol_activities') ?></td><td><input type="text" class="form-control" name="nama_contol_activities" id="nama_contol_activities" placeholder="Nama Contol Activities" value="<?php echo $nama_contol_activities; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_contol_activities" value="<?php echo $id_contol_activities; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('contol_activities') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>