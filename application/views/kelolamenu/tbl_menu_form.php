            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered table-hover'>        
                    ...
                    <tr>
                      ...
                      <?php echo form_error('url') ?></td>
                    </tr>
                    <tr>
                      <td width='200'>Icon </td>
                      <td><input type="text" class="form-control" name="icon" id="icon" placeholder="Icon" value="<?php echo $icon; ?>" />
                      <?php echo form_error('icon') ?></td>
                    </tr>
                    <tr><td width='200'>Is Main Menu <?php echo form_error('is_main_menu') ?></td>
                      <td><select name="is_main_menu" class="form-control">
                        ...
                        <?php echo form_error('is_main_menu') ?></td>
                    </tr>
                    <tr>
                      <td width='200'>Is Aktif </td>
                      <td><?php echo form_dropdown('is_aktif',array('y'=>'AKTIF','n'=>'TIDAK'),$is_aktif,array('class'=>'form-control'))?>
