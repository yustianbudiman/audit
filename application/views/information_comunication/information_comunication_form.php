    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA INFORMATION_COMUNICATION</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Information Comunication <?php echo form_error('nama_information_comunication') ?></td><td><input type="text" class="form-control" name="nama_information_comunication" id="nama_information_comunication" placeholder="Nama Information Comunication" value="<?php echo $nama_information_comunication; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_information_comunication" value="<?php echo $id_information_comunication; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('information_comunication') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>