            ...
            <div class="col-lg-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body pad" style="overflow: auto;">
                        ...
                        <?php echo anchor(site_url('divisi/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                        <?php echo anchor(site_url('divisi/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
                    </div>
