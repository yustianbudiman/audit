            ...
            <div class="col-lg-12">
                ...
                <div class="box box-info ">
                    ...
                    <div class="box-body">
                        ...
                        <?php echo anchor(site_url('cat_operasional_new/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                        <?php echo anchor(site_url('cat_operasional_new/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
                        <?php echo anchor(site_url('cat_operasional_new/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-warning btn-sm"'); ?>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    scrollCollapse: true,
                    fixedColumns: true,
                    ajax: {"url": "cat_operasional_new/json", "type": "POST"},
                    columns: [
                        {
