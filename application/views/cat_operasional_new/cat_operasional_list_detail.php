                ...
                <div class="box box-info">
                    ...
                    <div class="box-body pad">
                        ...
                        <?php echo anchor(site_url('cat_operasional/excel/'.$one_header_detail['id_cat_operasional_header']), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
                         <?php echo anchor(site_url('cat_operasional/word/'.$one_header_detail['id_cat_operasional_header'].'/'.$one_header_detail['periode'].'/'.$one_header_detail['periode']), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-warning btn-sm"'); ?>
                    </div>
