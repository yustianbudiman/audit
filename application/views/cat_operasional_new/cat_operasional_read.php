                    ...
                    <div class="box-body pad">
                        <div style="padding-bottom: 10px;">
                        	        ...
                        	        <table class="table table-bordered">
									    ...
									    <tr><td style="width: 20%">Created_by</td><td><?php echo $one_cat_operasional->created_name ?></td></tr>
									    <tr><td style="width: 20%">Updated_by</td><td><?php echo $one_cat_operasional->updated_name ?></td></tr>
									    <tr>
