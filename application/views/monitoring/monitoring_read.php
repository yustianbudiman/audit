        ...
        <div class="box box-info">
          ...
          <div class="box-body pad" style="overflow: auto;">
            <table class="table table-bordered table-hover">
        	    <tr><td>Nama Monitoring</td><td><?php echo $nama_monitoring; ?></td></tr>
        	    ...
        	    <tr><td></td><td><a href="<?php echo site_url('monitoring') ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Kembali</a>
            </table>
          </div>       
        </div>
      </div>
