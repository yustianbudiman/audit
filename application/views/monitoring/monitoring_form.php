          			...
          			<div class="box-header">
						<h3 class="box-title"><?php echo $button ?>
              			...
              			<div class="pull-right box-tools">
							<a href="<?php echo site_url('monitoring') ?>" class="btn btn-warning btn-sm"><i class="fa fa-angle-double-left"></i></a>
          			...
          			<div class="box-body pad" style="overflow: auto;">
            			<form action="<?php echo $action; ?>" method="post">
		      				...
		      				<table class='table table-bordered table-hover'>       
							    ...
							    <tr><td width='200'>Nama Monitoring </td>
							    	<td><input type="text" class="form-control" name="nama_monitoring" id="nama_monitoring" placeholder="Nama Monitoring" value="<?php echo $nama_monitoring; ?>" />
							    	<?php echo form_error('nama_monitoring') ?></td></tr>
							    ...
							    <tr>
	    							<td></td>
	    							<td><input type="hidden" name="id_monitoring" value="<?php echo $id_monitoring; ?>" /> 
			    						<button type="submit" class="btn btn-success"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
						    			<a href="<?php echo site_url('monitoring') ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
							</table>
						</form>  
          			</div>       
    	  		</div>
