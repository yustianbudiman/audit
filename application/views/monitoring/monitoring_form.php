    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA MONITORING</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Monitoring <?php echo form_error('nama_monitoring') ?></td><td><input type="text" class="form-control" name="nama_monitoring" id="nama_monitoring" placeholder="Nama Monitoring" value="<?php echo $nama_monitoring; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_monitoring" value="<?php echo $id_monitoring; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('monitoring') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>