    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA GOAL_STRATEGIC</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Goal Strategic <?php echo form_error('nama_goal_strategic') ?></td><td><input type="text" class="form-control" name="nama_goal_strategic" id="nama_goal_strategic" placeholder="Nama Goal Strategic" value="<?php echo $nama_goal_strategic; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_goal_strategic" value="<?php echo $id_goal_strategic; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('goal_strategic') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>