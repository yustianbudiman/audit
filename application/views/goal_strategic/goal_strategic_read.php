        ...
        <div class="box box-info">
          <div class="box-header">
              ...
              <div class="pull-right box-tools">
                  <a href="<?php echo site_url('goal_strategic') ?>" class="btn btn-warning btn-sm"><i class="fa fa-angle-double-left"></i></a>
          ...
          <div class="box-body pad" style="overflow: auto;">
            <table class="table table-bordered table-hover">
        	    <tr><td>Nama Goal Strategic</td><td><?php echo $nama_goal_strategic; ?></td></tr>
	            ...
	            <tr><td></td><td><a href="<?php echo site_url('goal_strategic') ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Kembali</a>
            </table>
          </div>       
        </div>
      </div>
