    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA RISK_ASSESMENT</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">
            
<table class='table table-bordered>'        

	    <tr><td width='200'>Nama Risk Assesment <?php echo form_error('nama_risk_assesment') ?></td><td><input type="text" class="form-control" name="nama_risk_assesment" id="nama_risk_assesment" placeholder="Nama Risk Assesment" value="<?php echo $nama_risk_assesment; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_risk_assesment" value="<?php echo $id_risk_assesment; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('risk_assesment') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>