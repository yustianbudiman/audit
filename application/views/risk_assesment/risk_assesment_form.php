          			...
          			<div class="box-body pad" style="overflow: auto;">
            			<form action="<?php echo $action; ?>" method="post">
		      				...
		      				<table class='table table-bordered table-hover'>        
							    ...
							    <tr><td width='200'>Nama Risk Assesment </td>
							    	<td><input type="text" class="form-control" name="nama_risk_assesment" id="nama_risk_assesment" placeholder="Nama Risk Assesment" value="<?php echo $nama_risk_assesment; ?>" />
							    	<?php echo form_error('nama_risk_assesment') ?></td></tr>
							    ...
							    <tr>
	    							<td></td>
	    							<td><input type="hidden" name="id_risk_assesment" value="<?php echo $id_risk_assesment; ?>" /> 
			    						<button type="submit" class="btn btn-success"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
						    			<a href="<?php echo site_url('risk_assesment') ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
							</table>
						</form>  
          			</div>       
    	  		</div>
