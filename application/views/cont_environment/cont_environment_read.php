...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Cont_environment Read</h2>
        <table class="table">
	    <tr><td>Nama Environment</td><td><?php echo $nama_environment; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('cont_environment') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>