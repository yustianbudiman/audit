...
ob_start();
$docx = new CreateDocxFromTemplate('assets/phpdocx-master/examples/files/CAT_BIS_SRH_FINAL1.docx');
...
$html = '<table border=1 style="border-collapse: collapse;width:100%">
            ...
            <tbody>';
            $i=1;
            foreach ($list_all_cat_bisnis as $key) {
         $html .='<tr>
                    <td>'.$i.'</td>
                    <td>'.$key['temuan'].'</td>
