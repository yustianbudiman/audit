    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA CAT_BISNIS</h3>
            </div>
...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Id Goal Stategic <?php echo form_error('id_goal_stategic') ?></td><td><input type="text" class="form-control" name="id_goal_stategic" id="id_goal_stategic" placeholder="Id Goal Stategic" value="<?php echo $id_goal_stategic; ?>" /></td></tr>
	    <tr><td width='200'>Goal Stategic Value <?php echo form_error('goal_stategic_value') ?></td><td><input type="text" class="form-control" name="goal_stategic_value" id="goal_stategic_value" placeholder="Goal Stategic Value" value="<?php echo $goal_stategic_value; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_cat_bisnis" value="<?php echo $id_cat_bisnis; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('cat_bisnis') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>