            ...
            <div class="col-lg-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body pad">
                        ...
                        <?php echo anchor(site_url('cat_bisnis/word/'.$one_header_detail['id_cat_bisnis_header']), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-warning btn-sm"'); ?>
                    </div>
