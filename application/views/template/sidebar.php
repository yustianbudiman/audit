<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><?php echo anchor('welcome',"<i class='fa fa-home'></i> <span>HOME</span>");?></li>
        <?php
        ...
        foreach ($main_menu as $menu){
            ...
            ORDER BY title ASC";
            $submenu = $this->db->query($sql_submenu);
            if($submenu->num_rows()>0){
                ...
                echo "<li class='treeview'>
                        ...
                        foreach ($submenu->result() as $sub){
                            echo "<li>".anchor($sub->url,"<i class='$sub->icon'></i> <span>".strtoupper($sub->title))."</span></li>"; 
                        }
                        echo" </ul>
                    </li>";
            }else{
